	...
	<title>Reciplan</title>
 	...
 	<body>
		...
		<?php	
			...
			printf("<img src=\"http://chart.apis.google.com/chart?chg=0,10,5,5&chf=bg,s,e2e2e2&chs=500x300&chd=t:%s|%s&chxt=x,y&chxr=0,0,%fE2|1,0,%fE1&cht=lxy\">",$data[0],$data[1],(float)$data[2]/100,(float)$data[3]/10);
		?>	
		</div>
